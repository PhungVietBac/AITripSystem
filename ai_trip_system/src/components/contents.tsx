      ...
      <div className="relative isolate overflow-hidden w-7xl bg-cyan-600 backdrop-blur-md px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
        <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          <h2 className="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">
            Du lịch thông minh với <span className="text-[#FFD700]">TravelGO!</span>
          </h2>
          <p className="mt-6 text-lg/8 text-pretty text-gray-300">
            Hệ thống đề xuất lộ trình du lịch thông minh dựa trên AI. <span className="text-[#FFD700]">TravelGO</span> giúp bạn tiết kiệm thời gian và công sức trong việc lên kế hoạch cho chuyến đi. Với nền tảng của chúng tôi, bạn có thể dễ dàng tìm kiếm, so sánh và đặt các dịch vụ du lịch chỉ trong vài phút.
          </p>
