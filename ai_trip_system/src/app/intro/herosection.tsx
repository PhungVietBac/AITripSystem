...
export default function HeroSections() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute top-4 left-1/3 text-white opacity-30 text-[9rem] animate-float-6">🚗</div>
        ...
        <div className="mx-auto max-w-2xl pt-4 pb-16 sm:pt-8 sm:pb-24 lg:pt-12 lg:pb-32">
          <div className="text-center -mt-4">
            <h1 className="text-4xl font-bold text-white sm:text-7xl">
              ...
              <div className="mt-9 font-['PlaywriteDKLoopet'] text-[#FFD700]">TravelGO!</div>
            </h1>
