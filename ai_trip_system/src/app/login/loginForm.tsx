            ...
            <div className="w-full max-w-md my-4">
                <div className="rounded-2xl shadow-xl filter backdrop-blur-md bg-[rgba(0, 0, 0, 0.1)] p-4 sm:p-6 md:p-8">
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-xl sm:text-2xl font-bold text-gray-800">Chào mừng bạn đến với EXPLAVUE 👋</h2>
                        <p className="text-gray-500 text-xs sm:text-sm mt-1">Vui lòng nhập thông tin của bạn!</p>
                    </div>
