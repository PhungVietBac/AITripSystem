...
export default function DetailedMapPlaceCard({ place, token }: DetailedMapPlaceCardProps) {
  ...
  const getActivitiesByType = (type: number | null): string[] => {
    switch (type) {
      case 0:
        return ["Thưởng thức ẩm thực", "Gặp gỡ bạn bè", "Trải nghiệm món ăn địa phương"];
      case 1:
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex border-b text-lg text-gray-900">
        <button
          ...
          className={`flex-1 py-2 font-medium ${activeTab === "info" ? "text-cyan-500 border-b-2 border-cyan-500" : "text-gray-600"}`}
        >
          Thông tin
        </button>
        <button
          onClick={() => setActiveTab("reviews")}
          className={`flex-1 py-2 font-medium ${activeTab === "reviews" ? "text-cyan-500 border-b-2 border-cyan-500" : "text-gray-600"}`}
        >
          Đánh giá
        </button>
      </div>
        ...
        {activeTab === "info" && (
          <div>
            <div className="mb-4">
              ...
              <p className="text-gray-600 text-sm">{place.description || "Chưa có thông tin mô tả."}</p>
            </div>
            <div className="mb-4">
              <h4 className="text-lg font-bold text-gray-800 mb-2">Thông tin chi tiết</h4>
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{uiHelperData.bestTimeToVisit}</p>
                  </div>
                </li>
                <li className="flex items-center gap-2">
            ...
            <div className="mb-6">
              <h4 className="text-lg font-bold text-gray-800 mb-3">Hoạt động nổi bật</h4>
