...
const ChatInterface = () => {
  ...
  const getBotResponse = (message: string): string => {
    ...
    } else if (lowerCaseMessage.includes("sài gòn") || lowerCaseMessage.includes("hồ chí minh") || lowerCaseMessage.includes("ho chi minh")) {
      return "TP.HCM có nhiều điểm tham quan như Nhà thờ Đức Bà, Bưu điện Trung tâm, Chợ Bến Thành. Bạn muốn đi trong bao lâu?";
    } else if (lowerCaseMessage.includes("khách sạn") || lowerCaseMessage.includes("hotel")) {
      return "Tôi có thể giúp bạn tìm khách sạn phù hợp. Bạn muốn ở khu vực nào và ngân sách của bạn là bao nhiêu?";
    } else if (lowerCaseMessage.includes("nhà hàng") || lowerCaseMessage.includes("ăn uống") || lowerCaseMessage.includes("restaurant")) {
      return "Tôi có thể gợi ý các nhà hàng ngon. Bạn thích ẩm thực gì và ở khu vực nào?";
    } else {
