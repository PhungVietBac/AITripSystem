...
# DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:password@localhost:5432/ai_trip_db")
# Use a raw string to avoid escaping issues
DATABASE_URL = r"postgresql://postgres:password@localhost:5432/ai_trip_db"
